 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://endpoint.jaxws.hello/", wsdlLocation = "http://localhost:8080/WS/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://endpoint.jaxws.hello/", "HelloImplService");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://endpoint.jaxws.hello/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.jaxws.hello/", "HelloImplPort"), Hello.class, features);
    }
